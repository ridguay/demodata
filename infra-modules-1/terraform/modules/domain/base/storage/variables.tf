...
variable "private_endpoint_subnet_id" {
  description = "The resource id of the subnet to deploy the private endpoint into\nExample: /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/mygroup1/providers/Microsoft.Network/virtualNetworks/myvnet1/subnets/mysubnet1"
  type        = string
}
...
variable "table_private_endpoint_ip" {
  description = "Ip of the table private endpoint."
  type        = string
}
