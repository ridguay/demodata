...
New-AzAutomationVariable -ResourceGroupName $ResourceGroup -AutomationAccountName $AutomationAccount -Name $runId -Value "" -Encrypted $True
...
Set-AzAutomationVariable -Name $runId -Value $updatedMachinesCommaSeperated -Encrypted $true -ResourceGroupName $Automation.ResourceGroupName -AutomationAccountName $Automation.Name
